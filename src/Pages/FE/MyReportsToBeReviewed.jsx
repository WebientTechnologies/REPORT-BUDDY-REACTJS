          ...
          <Box bg={'white'} mt={10} width='95%' m={'auto'} p={5} borderRadius={'10px'}>
               {
                    dashboardProjectsLoading ? (
                         ...
                         myReportsToBeReviewed && myReportsToBeReviewed?.length > 0 ? (
                              <CustomTable columns={allProjectsTableColumns} data={myReportsToBeReviewed ? myReportsToBeReviewed : []} searchEnabled={true} />
                         ) : (
...
export default MyReportsToBeReviewed;

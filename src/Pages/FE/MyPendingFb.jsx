          ...
          <Box bg={'white'} mt={10} width='95%' m={'auto'} p={5} borderRadius={'10px'}>
               {
                    dashboardProjectsLoading ? (
                         ...
                         feMyPendingFbProjects && feMyPendingFbProjects?.length > 0 ? (
                              <CustomTable columns={allProjectsTableColumns} data={feMyPendingFbProjects ? feMyPendingFbProjects : []} searchEnabled={true} />
                         ) : (

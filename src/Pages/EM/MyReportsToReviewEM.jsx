...
function MyReportsToReviewEM() {
     ...
     const [feMyReportsToReviewEMProjects, setMyProject] = useState(dashboardProjects || []);
     console.log({ feMyReportsToReviewEMProjects });
          ...
          <Box bg={'white'} mt={10} width='95%' m={'auto'} p={5} borderRadius={'10px'}>
               {
                    dashboardProjectsLoading ? (
                         ...
                         feMyReportsToReviewEMProjects && feMyReportsToReviewEMProjects?.length > 0 ? (
                              <CustomTable columns={allProjectsTableColumns} data={feMyReportsToReviewEMProjects ? feMyReportsToReviewEMProjects : []} searchEnabled={true} />
                         ) : (
...
export default MyReportsToReviewEM;

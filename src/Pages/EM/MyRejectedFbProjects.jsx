...
function MyRejectedFbProjects() {
     ...
     const [feMyRejectedFbProjectsProjects, setMyProject] = useState(dashboardProjects || []);
     console.log({ feMyRejectedFbProjectsProjects });
     ...
     const allProjectsTableColumns = useMemo(
          ...
          [feMyRejectedFbProjectsProjects]
     );
          ...
          <Box bg={'white'} mt={10} width='95%' m={'auto'} p={5} borderRadius={'10px'}>
               {
                    dashboardProjectsLoading ? (
                         ...
                         feMyRejectedFbProjectsProjects && feMyRejectedFbProjectsProjects?.length > 0 ? (
                              <CustomTable columns={allProjectsTableColumns} data={feMyRejectedFbProjectsProjects ? feMyRejectedFbProjectsProjects : []} searchEnabled={true} />
                         ) : (
...
export default MyRejectedFbProjects;

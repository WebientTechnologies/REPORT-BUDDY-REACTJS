...
function MyRejectedDraftReportsByQrTW() {
     ...
     const [feMyRejectedDraftReportsByQrTWProjects, setMyProject] = useState(dashboardProjects || []);
     console.log({ feMyRejectedDraftReportsByQrTWProjects });
     ...
     useEffect(() => {
          setMyProject(dashboardProjects?.filter((el) => el[`Project_Assigned_Form.TW`] === user?.name && el['PS_4.Stage_1'] === 'Rejected'));
     }, [dashboardProjects]);
     ...
     const allProjectsTableColumns = useMemo(
          ...
          [feMyRejectedDraftReportsByQrTWProjects]
     );
          ...
          <Box bg={'white'} mt={10} width='95%' m={'auto'} p={5} borderRadius={'10px'}>
               {
                    dashboardProjectsLoading ? (
                         ...
                         feMyRejectedDraftReportsByQrTWProjects && feMyRejectedDraftReportsByQrTWProjects?.length > 0 ? (
                              <CustomTable columns={allProjectsTableColumns} data={feMyRejectedDraftReportsByQrTWProjects ? feMyRejectedDraftReportsByQrTWProjects : []} searchEnabled={true} />
                         ) : (
...
export default MyRejectedDraftReportsByQrTW;

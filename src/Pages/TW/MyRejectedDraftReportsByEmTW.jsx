...
function MyRejectedDraftReportsByEmTW() {
     ...
     const [feMyRejectedDraftReportsByEmTWProjects, setMyProject] = useState(dashboardProjects || []);
     console.log({ feMyRejectedDraftReportsByEmTWProjects });
     ...
     useEffect(() => {
          setMyProject(dashboardProjects?.filter((el) => el[`Project_Assigned_Form.TW`] === user?.name && el['PS_4.Stage_5'] === 'Rejected'));
     }, [dashboardProjects]);
     ...
     const allProjectsTableColumns = useMemo(
          ...
          [feMyRejectedDraftReportsByEmTWProjects]
     );
          ...
          <Box bg={'white'} mt={10} width='95%' m={'auto'} p={5} borderRadius={'10px'}>
               {
                    dashboardProjectsLoading ? (
                         ...
                         feMyRejectedDraftReportsByEmTWProjects && feMyRejectedDraftReportsByEmTWProjects?.length > 0 ? (
                              <CustomTable columns={allProjectsTableColumns} data={feMyRejectedDraftReportsByEmTWProjects ? feMyRejectedDraftReportsByEmTWProjects : []} searchEnabled={true} />
                         ) : (
...
export default MyRejectedDraftReportsByEmTW;

...
function MyRejectedDraftReportsByFeTW() {
     ...
     useEffect(() => {
          setMyProject(dashboardProjects?.filter((el) => el[`Project_Assigned_Form.TW`] === user?.name && el['PS_4.Stage_3'] === 'Rejected'));
     }, [dashboardProjects]);
     ...
     const allProjectsTableColumns = useMemo(
          ...
          [feMyRejectedDraftReportsByFeTWProjects]
     );
          ...
          <Box bg={'white'} mt={10} width='95%' m={'auto'} p={5} borderRadius={'10px'}>
               {
                    dashboardProjectsLoading ? (
                         ...
                         feMyRejectedDraftReportsByFeTWProjects && feMyRejectedDraftReportsByFeTWProjects?.length > 0 ? (
                              <CustomTable columns={allProjectsTableColumns} data={feMyRejectedDraftReportsByFeTWProjects ? feMyRejectedDraftReportsByFeTWProjects : []} searchEnabled={true} />
                         ) : (
...
export default MyRejectedDraftReportsByFeTW;

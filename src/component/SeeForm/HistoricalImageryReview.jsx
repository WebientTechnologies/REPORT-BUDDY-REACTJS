...
function HistoricalImageryReview({setCommentFelid,getForm,  setLogFelid,getFormData}) {
const historicalImageryReview = getForm?.historicalImageryReview;
...
getFormData= {getFormData}
          defaultValue={historicalImageryReview?.aerial}
          fieldName="historicalImageryReview.aerial"
          height="150px"
      ...
      <Box w="100%" my="8">
        ...
        <InputChange
          ...
          setLogFelid={setLogFelid}
getFormData= {getFormData}
          defaultValue={historicalImageryReview?.realtor}
          fieldName="historicalImageryReview.realtor"
          height="150px"
          placeholder={`State in a bullet point format the particularly noteworthy items from the image. `}
          />
        </FormControl>
      ...
      <Box w="100%" my="8">
        ...
        <InputChange
          ...
          setLogFelid={setLogFelid}
getFormData= {getFormData}
          defaultValue={historicalImageryReview?.zillow}
          fieldName="historicalImageryReview.zillow"
          height="150px"
          placeholder={`State in a bullet point format the particularly noteworthy items from the image. `}
          />
      ...
      <Box w="100%" my="8">
        ...
        <InputChange
          ...
          setLogFelid={setLogFelid}
getFormData= {getFormData}
          defaultValue={historicalImageryReview?.redfin}
          fieldName="historicalImageryReview.redfin"
          height="150px"
          placeholder={`State in a bullet point format the particularly noteworthy items from the image. `}
          />

...
function Wrht({ setLogFelid, setCommentFelid, getForm ,getFormData}) {
...
getFormData= {getFormData}
            defaultValue={windAndRainfallData}
            fieldName={`wrht.windAndRainfallData`}
            height="150px"
      ...
      <Box w="100%" my="8">
        ...
        >
          <InputChange
            ...
            setLogFelid={setLogFelid}
getFormData= {getFormData}
            defaultValue={hailData1}
            fieldName={`wrht.hailData1`}
            height="150px"
      ...
      <Box w="100%" my="8">
        ...
        >
          <InputChange
            ...
            setLogFelid={setLogFelid}
getFormData= {getFormData}
            defaultValue={tornadoData}
            fieldName={`wrht.tornadoData`}
            height="450px"
      ...
      <Box w="100%" my="8">
        ...
        >
          <InputChange
            ...
            setLogFelid={setLogFelid}
getFormData= {getFormData}
            defaultValue={additionalWeatherData}
            fieldName={`wrht.additionalWeatherData`}
            height="150px"

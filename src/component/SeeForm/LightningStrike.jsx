...
function LightningStrike({setLogFelid, setCommentFelid, getForm,getFormData}) {
  const lightningStrike= getForm?.lightningStrike;
  return (
    <Box p="4">
...
getFormData= {getFormData}
          defaultValue={lightningStrike}
          fieldName="lightningStrike"
          height="150px"
